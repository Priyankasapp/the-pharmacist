...
const TreatmentSection = () => {
    ...
    useEffect(()=>{
        ...
        const handleResize = () => setTreatmentCardPerPage(getTreatmentCardsPerPage());
    ...
    <section className={styles['treatment-section']}>
        <div className={styles['treatment-header']}>
            <h2 className={styles['treatment-heading']}>
                From Better Sleep to Stronger Immunity, Discover <span>Lifestyle Treatments</span> That Improve Your <span>Daily</span> Wellness
            </h2>
            <div className={styles['treatment-slider']}>
                ...
                type='button'
                onClick={handleNext}
                disabled={currentIndex + treatmentCardPerPage >=treatmentData.length }
        ...
        <div className={styles['treatment-card-container']}>
            {visibleTreatmentCards.map((treatment)=>{
                return(
                    <div className={styles['treatment-card-item']}>
                        <TreatmentCard
                        id={treatment.id}
                        img={treatment.img}
